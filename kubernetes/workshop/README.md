...
- Preparing 3-Node Kubernetes Cluster
  ...
  - [Setting up WeaveScope For Visualization on Katakoda/PWK](https://github.com/collabnix/dockerlabs/blob/master/kubernetes/workshop/weave-Katakoda-PWD.md) - Done
