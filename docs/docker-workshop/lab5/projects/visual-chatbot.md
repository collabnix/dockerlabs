...
![first-prompt](https://github.com/ajeetraina/docker-workshop/tree/main/docs/lab5/projects/images/first-chat.png)
...
![second-prompt](https://github.com/ajeetraina/docker-workshop/tree/main/docs/lab5/projects/images/second-chat.png)

## Step 6. Change the system prompt

![system-prompt](https://github.com/ajeetraina/docker-workshop/tree/main/docs/lab5/projects/images/system-prompt.png)

Go to `Settings -> System prompt` and change the prompt to be the `"Grumpy old man"`.



![grumpy](https://github.com/ajeetraina/docker-workshop/tree/main/docs/lab5/projects/images/grumpy.png)

Before submitting, enable the `"replay messages"`. Then, press `save`.

## Step 7. Notice the very different persona

![grumpy-prompt](https://github.com/ajeetraina/docker-workshop/tree/main/docs/lab5/projects/images/grumpy-prompt.png)
...
![time-query](https://github.com/ajeetraina/docker-workshop/tree/main/docs/lab5/projects/images/time-query.png)

## Step 8. Adding Time Tool

Click "Add Time tool" to add a tool that will provide the current time in New York.

![add-time-tool](https://github.com/ajeetraina/docker-workshop/tree/main/docs/lab5/projects/images/add-time-tool.png)

## Step 9. Ask the LLM again

Now, ask the LLM again "What time is it in New York now?".

![time-response](https://github.com/ajeetraina/docker-workshop/tree/main/docs/lab5/projects/images/time-response.png)
